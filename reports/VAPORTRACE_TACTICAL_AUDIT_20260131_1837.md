...
| **MISSION START** | 2026-01-31 18:33:44 |
| **GEN TIME (UTC)** | 2026-01-31 18:37:48 |
...
| `https://petstore.swagger.io/v2/swagger.json` | T1592 | API9:2023 | ID.AM | **INFO** | Swagger/OpenAPI Documentation Found |
| `https://petstore.swagger.io/v2/swagger.json?debug=true` | T1596 | API3:2023 | ID.RA | **VULNERABLE** | Potential Hidden Parameter: debug |
| `https://petstore.swagger.io/v2/swagger.json?admin=true` | T1596 | API3:2023 | ID.RA | **VULNERABLE** | Potential Hidden Parameter: admin |
| `https://petstore.swagger.io/v2/swagger.json?test=true` | T1596 | API3:2023 | ID.RA | **VULNERABLE** | Potential Hidden Parameter: test |
| `https://petstore.swagger.io/v2/swagger.json?dev=true` | T1596 | API3:2023 | ID.RA | **VULNERABLE** | Potential Hidden Parameter: dev |
| `https://petstore.swagger.io/v2/swagger.json?internal=true` | T1596 | API3:2023 | ID.RA | **VULNERABLE** | Potential Hidden Parameter: internal |
| `https://petstore.swagger.io/v2/swagger.json?config=true` | T1596 | API3:2023 | ID.RA | **VULNERABLE** | Potential Hidden Parameter: config |
| `https://petstore.swagger.io/v2/swagger.json?role=true` | T1596 | API3:2023 | ID.RA | **VULNERABLE** | Potential Hidden Parameter: role |
| `https://petstore.swagger.io/v2/swagger.json` | T1592 | API9:2023 | ID.AM | **INFO** | Swagger/OpenAPI Documentation Found |
